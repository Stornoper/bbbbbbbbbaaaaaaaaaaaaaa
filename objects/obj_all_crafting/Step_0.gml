...
if (obj_player.has_crossbow == false){
	instance_create_layer(100, 100, "Instances_3", obj_crossbow_tower)
}
if (obj_player.has_inferno == false){
	instance_create_layer(164, 164, "Instances_3", obj_inferno)
}
if (obj_player.has_canon == false){
	instance_create_layer(x, y, "Instances_3", obj_canon)
}
...
if (obj_player.currently_crafting = "crossbow") && wood_count >= 5 && stone_count >= 1 && iron_count >= 2 && keyboard_check_released(vk_enter){
...
if (obj_player.currently_crafting = "inferno") && wood_count >= 3 && iron_count >= 5 && keyboard_check_released(vk_enter){
	obj_player.has_inferno = true;
	wood_count -= 3;
	iron_count -= 5;
	obj_player.currently_crafting = "niks"
}
if (obj_player.currently_crafting = "canon") && wood_count >= 4 && stone_count >= 4 && keyboard_check_released(vk_enter){
